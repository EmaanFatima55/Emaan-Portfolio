...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative pt-16 pb-8 px-6 overflow-hidden">
      <div className="absolute left-0 top-1/2 h-72 w-72 rounded-full bg-cyan-500/10 blur-[120px] -translate-y-1/2" />

      {/* ===== TOP-CENTER FLOATING NOTIFICATION (page-level, position: fixed) ===== */}
        ...
        <AnimatePresence>
          {status !== "idle" && (
            <motion.div
              ...
              className={`notif-banner notif-fixed ${
                status === "success" ? "notif-success" : "notif-error"
              }`}
            >
              {status === "success" ? (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl md:text-6xl font-bold text-cyan-400 leading-none">Contact</h2>
            ...
            <div className="mt-10 space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white">fatimaemaan5506@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white">+92 333 4435791</p>
                </div>
              </div>
            ...
            <div className="flex gap-4 mt-10">
              <a href="https://github.com/EmaanFatima55" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.linkedin.com/in/emaan-fatima-1ba698351" target="_blank" rel="noopener noreferrer"
                className="relative z-50 w-12 h-12 rounded-xl border border-cyan-400/20 bg-[#101827] hover:border-cyan-400 hover:bg-cyan-400/10 transition-all duration-300 flex items-center justify-center">
                <FaLinkedinIn size={20} />
              </a>
              <a href="https://wa.me/923334435791" target="_blank" rel="noopener noreferrer"
          ...
          {/* RIGHT — form (no banner inside anymore) */}
          <motion.div
            initial={{ opacity: 0, x: 40 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
